...
print("=" * 80)
print("MODULAR FORMS FOR Γ(3) (A₄ SYMMETRY) - FIXED")
print("=" * 80)
...
print(f"q = exp(2πiτ) = exp(-2πφ) = {float(mp.e**(-2*mp.pi*phi))}")
...
print(f"f1(τ) = η(3τ)³/η(τ) = {float(f1)}")

# f2(τ) = η(τ/3)^3 / η(τ)  
f2 = eta(tau/3)**3 / eta(tau)
print(f"f2(τ) = η(τ/3)³/η(τ) = {float(f2)}")
...
print(f"Y1 = {complex(Y1):.6f}")
print(f"Y2 = {complex(Y2):.6f}")
print(f"Y3 = {complex(Y3):.6f}")
...
masses_from_Y = [Y1_f**2, Y2_f**2, Y3_f**2]
